...
namespace ImGui
{
    ...
    IMGUI_API bool          Combo(const char* label, int* current_item, const char* const glow_entities_to_glow[], int items_count, int popup_max_height_in_items = -1);
    ...
    IMGUI_API bool          ListBox(const char* label, int* current_item, const char* const glow_entities_to_glow[], int items_count, int height_in_items = -1);
...
struct ImGuiStorage
{
    ...
    IMGUI_API int       get_int(ImGuiID key, int default_val = 0) const;
    IMGUI_API void      SetInt(ImGuiID key, int val);
    IMGUI_API bool      GetBool(ImGuiID key, bool default_val = false) const;
    IMGUI_API void      SetBool(ImGuiID key, bool val);
    IMGUI_API float     get_float(ImGuiID key, float default_val = 0.0f) const;
