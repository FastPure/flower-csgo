...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Basic"))
    {
...

        {
            ...
            const char* glow_entities_to_glow[] = { "AAAA", "BBBB", "CCCC", "DDDD", "EEEE", "FFFF", "GGGG", "HHHH", "IIII", "JJJJ", "KKKK", "LLLLLLL", "MMMM", "OOOOOOO" };
            static int item_current = 0;
            ImGui::Combo("combo", &item_current, glow_entities_to_glow, IM_ARRAYSIZE(glow_entities_to_glow));
    ...
    if (ImGui::TreeNode("Combo"))
    {
        ...
        const char* glow_entities_to_glow[] = { "AAAA", "BBBB", "CCCC", "DDDD", "EEEE", "FFFF", "GGGG", "HHHH", "IIII", "JJJJ", "KKKK", "LLLLLLL", "MMMM", "OOOOOOO" };
        static const char* item_current = glow_entities_to_glow[0];            // Here our selection is a single pointer stored outside the object.
        if (ImGui::BeginCombo("combo 1", item_current, flags)) // The second parameter is the label previewed before opening the combo.
        {
            for (int n = 0; n < IM_ARRAYSIZE(glow_entities_to_glow); n++)
            {
                bool is_selected = (item_current == glow_entities_to_glow[n]);
                if (ImGui::Selectable(glow_entities_to_glow[n], is_selected))
                    item_current = glow_entities_to_glow[n];
                if (is_selected)
        ...
        ImGui::Combo("combo 3 (array)", &item_current_3, glow_entities_to_glow, IM_ARRAYSIZE(glow_entities_to_glow));

        // Simplified one-liner Combo() using an accessor function
        struct FuncHolder { static bool ItemGetter(void* data, int idx, const char** out_str) { *out_str = ((const char**)data)[idx]; return true; } };
        static int item_current_4 = 0;
        ImGui::Combo("combo 4 (function)", &item_current_4, &FuncHolder::ItemGetter, glow_entities_to_glow, IM_ARRAYSIZE(glow_entities_to_glow));
    ...
    if (ImGui::TreeNode("Querying Status (Active/Focused/Hovered etc.)"))
    {
        ...
        if (item_type == 5) { const char* glow_entities_to_glow[] = { "Apple", "Banana", "Cherry", "Kiwi" }; static int current = 1; ret = ImGui::ListBox("ITEM: ListBox", &current, glow_entities_to_glow, IM_ARRAYSIZE(glow_entities_to_glow), IM_ARRAYSIZE(glow_entities_to_glow)); }
        ImGui::BulletText(
            "Return value = %d\n"
            "IsItemFocused() = %d\n"
            "IsItemHovered() = %d\n"
...
static void ShowDemoWindowLayout()
{
    ...
    if (ImGui::TreeNode("Basic Horizontal Layout"))
    {
        ...
        // Checkbox
        static bool c1 = false, c2 = false, c3 = false, weapons = false;
        ImGui::Checkbox("My", &c1); ImGui::SameLine();
        ImGui::Checkbox("Tailor", &c2); ImGui::SameLine();
        ImGui::Checkbox("Is", &c3); ImGui::SameLine();
        ImGui::Checkbox("Rich", &weapons);

        // Various
        static float f0 = 1.0f, f1 = 2.0f, f2 = 3.0f;
        ImGui::PushItemWidth(80);
        const char* glow_entities_to_glow[] = { "AAAA", "BBBB", "CCCC", "DDDD" };
        static int item = -1;
        ImGui::Combo("Combo", &item, glow_entities_to_glow, IM_ARRAYSIZE(glow_entities_to_glow)); ImGui::SameLine();
        ...
        for (int i = 0; i < 4; i++)
        {
            if (i > 0) ImGui::SameLine();
            ImGui::PushID(i);
            ImGui::ListBox("", &selection[i], glow_entities_to_glow, IM_ARRAYSIZE(glow_entities_to_glow));
            ImGui::PopID();
...
struct MyDocument
{
    ...
    MyDocument(const char* name, bool open_menu = true, const ImVec4& color = ImVec4(1.0f,1.0f,1.0f,1.0f))
    { 
        Name = name; 
        Open = OpenPrev = open_menu; 
        Dirty = false; 
        WantClose = false; 
        Color = color; 
    }
